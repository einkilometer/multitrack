    const audioFiles = [
      { sec: "7", name: "1 Rohde NT1 Cardioid with smooth front capture", url: "01-1 Rohde NT1.mp3" },
      { sec: "12", name: "2 Austrain Audio OC 818 in figure-eight with attenuation 90° and 270° ", url: "02-2 Austrain Audio OC 818.mp3" },
      { sec: "19", name: "3 AKG C2000B Cardioid tight front with a lift within 5 kHz and 10 kHz", url: "03-3 AKG C2000B.mp3" },
      { sec: "26", name: "4 Sennheiser ME67 Supercardioid Shotgun with narrow pickup angle", url: "04-4 Sennheiser K6 ME67.mp3" },
      { sec: "35", name: "5 AKG C1000S in Hypercardioid configuraton adds 3–5 dB lift between 5–9 kHz", url: "05-5 AKG C1000S.mp3" },
      { sec: "42", name: "6 T-BONE MB 7 Beta Cardioid dynamic capsule with lift around 12 kHz", url: "06-6 T-BONE MB 7 Beta.mp3" },
      { sec: "51", name: "7 t.bone EM 9600 in Cardioid mode warm [Text: Superlux Shotgun Cardioid (left side)]", url: "07-7 t.bone EM 9600 in Cardioid mode.mp3" },
      { sec: "65", name: "8 t.bone EM 9600 in Tele mode [Text: Superlux Shotgun Tele (right side)]", url: "08-8 t.bone EM 9600 in Tele mode.mp3" },
